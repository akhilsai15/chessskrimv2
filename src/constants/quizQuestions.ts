...
export const QUIZ_CATEGORIES: QuizCategory[] = [
  {
    ...
    questions: [
      {
        question: "Who scored 100 centuries in international cricket?",
        options: [
          "Virat Kohli",
          "Sachin Tendulkar",
          "Rohit Sharma",
      ...
      },
      {
        ...
        options: ["Sourav Ganguly", "Kapil Dev", "Rahul Dravid", "MS Dhoni"],
      ...
      {
        question: "Which country won the first Men's T20 World Cup?",
        options: ["Pakistan", "Australia", "India", "West Indies"],
        correctAnswerIndex: 2,
      },
      {
        question: "What is the length of a cricket pitch?",
        options: ["20 yards", "22 yards", "24 yards", "21 yards"],
        correctAnswerIndex: 1,
      },
      {
        question:
          "Who took 10 wickets in an innings in a Test match for India?",
        options: ["Kapil Dev", "Anil Kumble", "Harbhajan Singh", "R Ashwin"],
        correctAnswerIndex: 1,
      },
      {
      ...
      {
        question: "Which player has the most sixes in international cricket?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question:
          "Which movie holds the record for the longest-running film in Indian theatres?",
        options: [
          "Sholay",
          "Hum Aapke Hain Koun",
      ...
      {
        question: "What is the real name of actor Akshay Kumar?",
        options: [
      ...
      {
        question:
          "Which film won the Oscar for Best Original Song for 'Jai Ho'?",
        options: [
          "Swades",
          "Slumdog Millionaire",
          "Lagaan",
      ...
      {
        question: "In '3 Idiots', what was Rancho's real name?",
        options: [
          "Phunsukh Wangdu",
          "Chatur Ramalingam",
          "Raju Rastogi",
      ...
      {
        question: "Which Bollywood movie features the song 'Chaiyya Chaiyya'?",
        options: ["Dil Se", "Kuch Kuch Hota Hai", "Taal", "Lagaan"],
        correctAnswerIndex: 0,
      },
      {
        question: "Who played the role of 'Circuit' in Munna Bhai M.B.B.S.?",
        options: ["Boman Irani", "Arshad Warsi", "Sanjay Dutt", "Paresh Rawal"],
        correctAnswerIndex: 1,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Yamuna", "Godavari", "Brahmaputra", "Ganges (Ganga)"],
        correctAnswerIndex: 3,
      },
      {
      ...
      {
        question:
          "Which Indian state is entirely surrounded by land and has no coastline?",
        options: ["Gujarat", "Madhya Pradesh", "Maharashtra", "Kerala"],
        correctAnswerIndex: 1,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question:
          "Which social media platform is famous for a 280-character limit?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question:
          "The Indus Valley Civilization was centered around which river?",
      ...
      },
      {
        ...
        options: ["Nefertiti", "Cleopatra", "Hatshepsut", "Boudica"],
        correctAnswerIndex: 1,
      },
      {
      ...
      },
      {
        ...
        options: ["Sun Yat-sen", "Qin Shi Huang", "Mao Zedong", "Confucius"],
        correctAnswerIndex: 1,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["The Beatles", "Rolling Stones", "Queen", "Led Zeppelin"],
        correctAnswerIndex: 2,
      },
      {
      ...
      {
        question: "Who won the Mozart of Madras title?",
        options: [
          "Ilaiyaraaja",
          "A. R. Rahman",
          "M. M. Keeravani",
      ...
      {
        question: "Which famous composer was deaf later in his life?",
        options: ["Mozart", "Bach", "Beethoven", "Chopin"],
        correctAnswerIndex: 2,
      },
      {
        question: "What is a group of three musicians called?",
        options: ["Duet", "Trio", "Quartet", "Quintet"],
        correctAnswerIndex: 1,
      },
      {
        question: "Which genre of music originated in Jamaica?",
        options: ["Jazz", "Hip Hop", "Reggae", "Blues"],
        correctAnswerIndex: 2,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        question: "Which cheese is traditionally used on a pizza?",
        options: ["Cheddar", "Swiss", "Mozzarella", "Parmesan"],
        correctAnswerIndex: 2,
      },
      {
      ...
      {
        question: "What is the staple food in South India?",
        options: ["Wheat", "Rice", "Corn", "Millet"],
        correctAnswerIndex: 1,
      },
      {
        question: "What type of pasta translates to 'little worms'?",
        options: ["Spaghetti", "Macaroni", "Linguine", "Vermicelli"],
        correctAnswerIndex: 3,
      },
      {
        question: "Which spice makes curry yellow?",
      ...
      },
      {
        ...
        options: ["Tapas", "Paella", "Tortilla", "Gazpacho"],
        correctAnswerIndex: 1,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        question: "Who holds the record for the 100m sprint?",
        options: ["Tyson Gay", "Yohan Blake", "Usain Bolt", "Carl Lewis"],
        correctAnswerIndex: 2,
      },
      {
        question: "What piece of equipment is hit in badminton?",
        options: ["Ball", "Shuttlecock", "Puck", "Birdie"],
        correctAnswerIndex: 1,
      },
      {
        question: "Which sport takes place in a velodrome?",
        options: ["Swimming", "Ice Skating", "Cycling", "Gymnastics"],
        correctAnswerIndex: 2,
      },
    ],
  },
