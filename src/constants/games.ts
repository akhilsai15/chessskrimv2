export const AVAILABLE_GAMES = [
  {
    ...
    label: "Snake",
    emoji: "🐍",
    tagline: "Beat my score! Fast reflexes",
    isMultiplayer: false,
    defaultScore: 580,
  },
  {
    ...
    label: "Tic Tac Toe",
    emoji: "⭕",
    tagline: "Classic battle of minds!",
    isMultiplayer: true,
  },
  {
    id: "emoji_guess",
    label: "Emoji Guess",
    emoji: "🎯",
    tagline: "Can you beat my emoji score?",
    isMultiplayer: false,
    defaultScore: 850,
  },
  {
    ...
    label: "Quiz Battle",
    emoji: "📚",
    tagline: "Who knows more? Let's find out",
    isMultiplayer: true,
  },
  {
    id: "snakes_ladders",
    ...
    emoji: "🎲",
    tagline: "Roll dice, climb ladders!",
    isMultiplayer: true,
  },
  {
    id: "kabaddi",
    label: "Kabaddi",
    emoji: "🏏",
    tagline: "Traditional tag battle!",
    isMultiplayer: true,
  },
];
