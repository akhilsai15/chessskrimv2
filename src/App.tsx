      ...
      {pulseToasts.map((toast) => (
        <div
          ...
          onClick={() => {
            ...
            navigate("/wallet"); // Example wallet route
          }}
        >
          ...
          <div className="bg-[#1F1F1F] rounded-2xl border border-white/5 p-4 relative overflow-hidden">
            ...
            <div className="flex -space-x-2 mb-3">
              <img
                ...
                className="w-8 h-8 rounded-full border-2 border-[#1F1F1F] object-cover"
                alt="user"
              />
              <img
              ...
              <img
                ...
                alt="user"
              />
              <div className="w-8 h-8 rounded-full bg-white/10 border-2 border-[#1F1F1F] flex items-center justify-center text-[9px] font-bold">
                +12
              </div>
            </div>
