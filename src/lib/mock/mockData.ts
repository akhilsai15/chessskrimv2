const funnyUsers = [
  {
    name: "Bappu Bhai Sharma",
    username: "bappu_bhai",
    bio: "Chai peeta hoon,\n  sapne bechta hoon ☕🚀",
  },
  {
    name: "Pappu Pandey",
    username: "pappu_pass_hogaya",
    bio: "Finally passed 12th\n  in 5th attempt 🎓😂",
  },
  {
    name: "Sunita Williams Gupta",
    username: "sunita_not_astronaut",
    bio: "Naam sunita hai\n  space mein nahi gayi main 😅",
  },
  {
    name: "Raju Rastogi",
    username: "raju_3idiots_fan",
    bio: "All izz well 🙏\n  Engineering dropout\n  turned influencer 💪",
  },
  {
    name: "Dolly Devi Tiwari",
    username: "dolly_ka_dhaba",
    bio: "Khana banati hoon,\n  reels banati hoon,\n  dil jodti hoon ❤️🍛",
  },
  {
    name: "Chikoo Singh",
    username: "chikoo_bhai_official",
    bio: "Gym jaata hoon\n  lekin sirf selfie ke liye 💪😂",
  },
  {
    name: "Munni Lal Verma",
    username: "munni_badnaam_nahi",
    bio: "Content creator 📱\n  Ghar se hi kaam,\n  pyjame mein fame 😎",
  },
  {
    name: "Bablu Mechanic",
    username: "bablu_ka_garage",
    bio: "Car theek karta hoon,\n  dil bhi theek karta hoon 🔧❤️",
  },
  {
    name: "Pinky Patel",
    username: "pinky_se_pink_nahi",
    bio: "Surat se hoon,\n  dil se Mumbaikar 🌸",
  },
  {
    name: "Golu Mishra",
    username: "golu_fitness_goals",
    bio: "Roz gym jaata hoon,\n  roz samosa bhi khata hoon 🏋️🥟",
  },
];
...
export const mockChats = Array.from({ length: 5 }).map((_, i) => ({
  id: `chat_${i + 1}`,
  name:
    i === 2 ? "Creator Group Hub" : mockUsers[i % mockUsers.length].displayName,
  username:
    i === 2 ? "creator_group_hub" : mockUsers[i % mockUsers.length].username,
  avatar:
    i === 2
      ? "https://picsum.photos/100/100?random=999"
      : mockUsers[i % mockUsers.length].avatar,
...
export const mockMessages = Array.from({ length: 20 }).map((_, i) => ({
  ...
  text:
    i % 2 === 0
      ? "That sounds awesome! 😎"
      : "Check out this new feature I built today.",
