...
export const BADGE_DEFINITIONS: Record<string, BadgeDef> = {
  ...
  spark: {
    ...
    icon: "✨",
    color: "#888888",
    bgRgba: "rgba(136,136,136,0.15)",
    category: "creator",
    desc: "Starting your journey on SkrimChat. Need 500 Pulse Score for Rising tier.",
  },
  rising: {
    id: "rising",
    name: "RISING",
    ...
    category: "creator",
    desc: "Earned by reaching 500 Pulse Score!",
    nextLvlDesc: "Next level: FLAME CREATOR (2,000)",
  },
  flame_creator: {
    id: "flame_creator",
    name: "FLAME CREATOR",
    icon: "🔥",
    color: "#FF6B00",
    bgRgba: "rgba(255,107,0,0.15)",
    category: "creator",
    desc: "Earned by reaching 2,000 Pulse Score!",
    nextLvlDesc: "Next level: BLAZE CREATOR (5,000)",
  },
  blaze_creator: {
    id: "blaze_creator",
    name: "BLAZE CREATOR",
    icon: "⚡",
    color: "#B026FF",
    bgRgba: "rgba(176,38,255,0.15)",
    category: "creator",
    desc: "Earned by reaching 5,000 Pulse Score!",
    nextLvlDesc: "Next level: NOVA CREATOR (10,000)",
  },
  nova_creator: {
    id: "nova_creator",
    name: "NOVA CREATOR",
    icon: "🚀",
    color: "#FF2D87",
    bgRgba: "rgba(255,45,135,0.15)",
    category: "creator",
    desc: "Earned by reaching 10,000 Pulse Score!",
    nextLvlDesc: "Next level: LEGEND (20,000)",
  },
  legend: {
    id: "legend",
    name: "LEGEND",
    icon: "👑",
    color: "#FFD700",
    bgRgba: "rgba(255,215,0,0.15)",
    category: "creator",
    desc: "The top tier! You earned 20,000+ Pulse Score.",
    isGradient: true,
  },
  ...
  week_warrior: {
    ...
    icon: "🏅",
    color: "#C0C0C0",
    bgRgba: "rgba(192,192,192,0.15)",
    category: "blazeRun",
    desc: "Earned by hitting a 7+ day Blaze Run.",
  },
  consistent: {
    id: "consistent",
    name: "CONSISTENT",
    ...
    bgRgba: "rgba(255,107,0,0.15)",
    category: "blazeRun",
    desc: "Earned by hitting a 30+ day Blaze Run.",
  },
  dedicated: {
    id: "dedicated",
    name: "DEDICATED",
    ...
    bgRgba: "rgba(0,240,255,0.15)",
    category: "blazeRun",
    desc: "Earned by hitting a 100+ day Blaze Run.",
  },
  skrimchat_og: {
    id: "skrimchat_og",
    name: "SKRIMCHAT OG",
    ...
    bgRgba: "rgba(255,215,0,0.15)",
    category: "blazeRun",
    desc: "A full year on fire! 365+ day Blaze Run.",
    isGradient: true,
  },
  ...
  hot_vibe: {
    ...
    bgRgba: "rgba(255,107,0,0.15)",
    category: "vibeRating",
    desc: "Maintained a Vibe Rating of 7.0+.",
  },
  loved: {
    id: "loved",
    name: "LOVED",
    ...
    bgRgba: "rgba(176,38,255,0.15)",
    category: "vibeRating",
    desc: "Maintained a stellar Vibe Rating of 9.0+.",
  },
  perfect_vibe: {
    id: "perfect_vibe",
    name: "PERFECT VIBE",
    ...
    bgRgba: "rgba(255,215,0,0.15)",
    category: "vibeRating",
    desc: "A flawless 10.0 Vibe Rating!",
    isGradient: true,
  },
  ...
  rising_star: {
    ...
    desc: "Earned by getting 1K+ profile views.",
  },
  trending: {
    id: "trending",
    name: "TRENDING",
    ...
    bgRgba: "rgba(255,45,135,0.15)",
    category: "profileViews",
    desc: "Earned by getting 10K+ profile views.",
  },
  viral: {
    id: "viral",
    name: "VIRAL",
    ...
    bgRgba: "rgba(255,215,0,0.15)",
    category: "profileViews",
    desc: "Massive reach! 100K+ profile views.",
    isGradient: true,
  },
  ...
  verified: {
    ...
    bgRgba: "rgba(0,240,255,0.15)",
    category: "followers",
    desc: "Verified status! 100K+ followers.",
  },
  elite: {
    id: "elite",
    name: "ELITE",
    ...
    bgRgba: "rgba(255,215,0,0.15)",
    category: "followers",
    desc: "The 1 Million Follower Elite club.",
    isGradient: true,
  },
  ...
  triple_crown: {
    ...
    bgRgba: "rgba(255,215,0,0.15)",
    category: "special",
    desc: "Achieved Vibe 9+, Pulse Score 5K+, and Blaze Run 30+.",
    isGradient: true,
  },
};
