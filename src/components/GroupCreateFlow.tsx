...
export function GroupCreateFlow({ onClose, onGroupCreated }: Props) {
  ...
  const [avatar, setAvatar] = useState<{ emoji: string; bg: string } | null>(
    null,
  );
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        onGroupCreated({
          ...
          avatar: avatar
            ? `https://ui-avatars.com/api/?name=${avatar.emoji}&background=random&color=fff`
          ...
          <div className="flex flex-col h-full">
            ...
            {selectedIds.length > 0 && (
              <div className="px-4 pb-2">
                <h3
                  className={`text-xs font-bold mb-3 tracking-wider ${selectedIds.length > 256 ? "text-red-400" : "text-white/50"}`}
                >
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="w-4 h-4 bg-white/10 rounded-full flex items-center justify-center text-white/70 hover:bg-white/20 hover:text-white ml-1"
                          >
                            <X size={10} />
                          </button>
                        </motion.div>
            ...
            <div className="flex-1 overflow-y-auto mt-2">
              {filteredContacts.length === 0 ? (
                ...
                <>
                  <div className="px-4 py-2 text-xs font-bold text-white/50 tracking-wider">
                    ALL CONTACTS (A-Z)
                  </div>
                    ...
                    return (
                      ...
                      >
                        <div className="relative w-10 h-10 mr-4">
                          ...
                          />
                          {contact.online && (
                            <div className="absolute right-0 bottom-0 w-3 h-3 bg-emerald-500 rounded-full border-2 border-[#1A1A24]" />
                          )}
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-white/50 truncate border-white/50">
                            {contact.lastSeen}
                          </div>
                        </div>
                        <div className="ml-4">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
              <div className="flex flex-col items-center justify-center py-4">
                ...
                >
                  {avatar ? (
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${avatar.bg} flex items-center justify-center text-4xl`}
                    >
                      {avatar.emoji}
                    </div>
                  ) : (
              ...
              <div>
                <label className="text-xs text-white/50 font-bold tracking-wider mb-2 block">
                  GROUP NAME
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <div className="text-xs text-white/50 mt-2 px-1">
                  {isPublic
                    ? "Anyone can search and join this group via link."
                    : "Only invited members can join."}
                </div>
              </div>

              <div>
                <label className="text-xs text-white/50 font-bold tracking-wider mb-2 block uppercase">
                  Permissions
                </label>
              ...
              {showAvatarPicker && (
                <>
                  ...
                  >
                    ...
                    <div className="text-xs font-bold text-white/50 tracking-wider mb-3 uppercase">
