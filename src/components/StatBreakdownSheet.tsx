...
export function StatBreakdownSheet({
  isOpen,
  onClose,
  type,
  stats,
}: StatBreakdownSheetProps) {
      ...
      <div className="fixed inset-0 z-[150] flex flex-col justify-end pointer-events-none">
        ...
        >
          ...
          <div className="flex flex-col items-center pt-4 pb-2 relative shrink-0 z-20 bg-transparent">
            ...
            <button
              onClick={onClose}
              className="absolute right-4 top-4 p-2 rounded-full bg-white/5 hover:bg-white/10 transition"
            >
            ...
            <h3 className="text-white font-bold text-lg flex items-center gap-2">
              ...
              {type === "blaze" && (
                <span className="text-xl">🔥 Blaze Run</span>
              )}
              {type === "views" && (
                <span className="text-xl">👁️ Profile Views</span>
              )}
              {type === "vibe" && (
                <span className="text-xl">💜 Vibe Rating</span>
              )}
            </h3>
          </div>
            ...
            {type === "pulse" && (
              <div className="space-y-6">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl relative overflow-hidden">
                  ...
                  <h4 className="text-sm font-bold text-yellow-400 mb-2 relative z-10">
                    What is Pulse Score?
                  </h4>
                  <p className="text-sm text-gray-300 italic relative z-10 leading-relaxed">
                    "Your influence level on SkrimChat. The higher your score,
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-4 bg-white/10 rounded-full overflow-hidden relative">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{
                        width: `${Math.min((stats.pulse / 5000) * 100, 100)}%`,
                      }}
                ...
                <div className="space-y-3 pt-2">
                  <h4 className="text-xs font-bold text-gray-400 tracking-wider uppercase border-b border-white/10 pb-2">
                    How it's calculated:
                  </h4>
                  <div className="space-y-2 text-sm text-gray-300 bg-white/5 p-4 rounded-xl border border-white/10">
                    <div className="flex justify-between">
                      <span>⚡ Post gets Pulsed</span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400 font-bold">+8 pts</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <p className="text-sm text-white font-medium">
                    Need {Math.max(5000 - stats.pulse, 0).toLocaleString()} more
                    points
                  </p>
                  ...
                  <p className="text-right text-[10px] text-gray-500 font-bold">
                    {stats.pulse.toLocaleString()}/5,000
                  </p>
                </div>
                ...
                <div className="bg-neon-purple/10 border border-neon-purple/30 p-4 rounded-xl">
                  <p className="text-sm font-medium text-neon-purple text-center">
                    <span className="font-bold">💡 TIP:</span> Share a Vibe
                    today to earn +50 bonus points!
                  </p>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="space-y-2 text-sm text-gray-300">
                    <div className="flex gap-3">
                      <span className="text-green-400 font-bold w-8">+10</span>{" "}
                      <span className="text-yellow-400">⚡</span> @raju followed
                      you
                    </div>
                    <div className="flex gap-3">
                      <span className="text-green-400 font-bold w-8">+5</span>{" "}
                      <span className="text-yellow-400">⚡</span> @dolly pulsed
                      your post
                    </div>
                    <div className="flex gap-3">
                      <span className="text-green-400 font-bold w-8">+8</span>{" "}
                      <span className="text-yellow-400">⚡</span> @chikoo shared
                      your reel
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="text-center mb-6">
                  <div className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500 tracking-tighter drop-shadow-md">
                    {stats.blaze}{" "}
                    <span className="text-2xl text-gray-400 font-bold bg-none bg-clip-border text-white/50">
                      days
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl relative overflow-hidden">
                  ...
                  <h4 className="text-sm font-bold text-orange-500 mb-2 relative z-10">
                    What is Blaze Run?
                  </h4>
                  <p className="text-sm text-gray-300 italic relative z-10 leading-relaxed">
                    "How many days in a row you've been active on SkrimChat.
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <p className="text-xs text-gray-400 mb-2">
                    Do ANY of these daily:
                  </p>
                  <div className="space-y-2 text-sm text-gray-300 bg-white/5 p-4 rounded-xl border border-white/10">
                    <div className="flex justify-between items-center">
                      <span>📸 Post a photo/reel</span>
                      <span>✅</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>✨ Add a Spark story</span>
                      <span>✅</span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      <span>⚡ Pulse someone's post</span>
                      <span>✅</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>👀 Watch 3 Vibes</span>
                      <span>✅</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="space-y-3 text-sm text-gray-300 px-2 py-2">
                    <div className="flex items-center gap-3">
                      <span className="w-16 font-mono text-white/50">
                        7 days
                      </span>{" "}
            ...
            {type === "views" && (
              <div className="space-y-6">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl relative overflow-hidden">
                  ...
                  <h4 className="text-sm font-bold text-blue-400 mb-2 relative z-10">
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="flex items-end gap-3 mb-2">
                    ...
                    <span className="text-green-400 text-sm font-bold tracking-wide mb-1 flex items-center gap-1">
                      vs last month: +234 ↑ 35%
                    </span>
                  </div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3">
                        <span className="w-8 text-[11px] font-bold text-gray-400">
                          {row.day}
                        </span>
                        ...
                        <span className="w-8 text-[11px] font-bold text-white text-right">
                          {row.val}
                        </span>
                      </div>
                    ))}
                    <div className="flex items-center gap-3 pt-1">
                      <span className="w-8 text-[11px] font-bold text-green-400">
                        Today
                      </span>
                      ...
                      <span className="w-8 text-[11px] font-bold text-green-400 text-right">
                        {stats.views % 100}
                      </span>
                    </div>
                  </div>
                ...
                <div className="bg-blue-400/10 border border-blue-400/30 p-4 rounded-xl mt-4">
                  <p className="text-sm font-medium text-blue-400 text-center">
                    <span className="font-bold">💡 TIP:</span> Add a bio and
                    website to get more views!
                  </p>
                </div>
              </div>
            )}
            ...
            {type === "vibe" && (
              <div className="space-y-6">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl relative overflow-hidden">
                  ...
                  <h4 className="text-sm font-bold text-purple-400 mb-2 relative z-10">
                    What is Vibe Rating?
                  </h4>
                  <p className="text-sm text-gray-300 italic relative z-10 leading-relaxed">
                    "Your community reputation. Based on how people react to
                    your content. Max: 10 💜"
                  </p>
                </div>
                ...
                <div className="text-center space-y-1 py-2">
                  <h4 className="text-xs font-bold text-gray-400 tracking-wider">
                    YOUR RATING: {stats.vibe}/10
                  </h4>
                  <div className="text-lg tracking-[0.2em]">
                    {Array.from({ length: 10 }).map((_, i) => (
                      <span
                        key={i}
                        className={
                          i < Math.floor(stats.vibe)
                            ? "text-purple-500 drop-shadow-[0_0_5px_currentColor]"
                            : "text-gray-600"
                        }
                      >
                        ★
                  ...
                  <p className="text-purple-400 font-extrabold text-sm tracking-widest uppercase pt-1">
                    EXCELLENT!
                  </p>
                </div>
                ...
                <div className="space-y-3 pt-4">
                  ...
                  <div className="space-y-3 bg-white/5 p-4 rounded-xl border border-white/10 text-sm">
                    <div className="flex gap-3 items-center">
                      <span className="w-48 text-gray-300">
                        ⚡ Positive reactions
                      </span>
                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="flex-1 h-1.5 bg-white/10 rounded-full overflow-hidden">
                        <div className="h-full bg-purple-400 w-[82%]" />
                      </div>
                      <span className="text-xs font-bold text-white w-8 text-right">
                        82%
                      </span>
                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      <span className="text-xs font-bold text-green-400 w-8 text-right">
                        0%
                      </span>
                    </div>
                  </div>
                ...
                <div className="space-y-3 pt-6">
                  ...
                  <div className="space-y-2 text-[13px] text-gray-300 px-2 font-medium">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-500 font-mono w-10">0-4</span>{" "}
                      <span>😴 Sleepy Vibe</span>
                      <span className="w-16"></span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-500 font-mono w-10">4-6</span>{" "}
                      <span>😊 Good Vibe</span>
                      <span className="w-16"></span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-500 font-mono w-10">6-8</span>{" "}
                      <span>🔥 Hot Vibe</span>
                      <span className="w-16"></span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-500 font-mono w-10">8-9</span>{" "}
                      <span>⚡ Electric Vibe</span>
                      <span className="w-16"></span>
                    </div>
                    <div className="flex items-center justify-between text-purple-400 font-bold bg-purple-500/10 -mx-2 px-2 py-1 rounded">
                      <span className="text-purple-500 font-mono w-10">
                        9-10
                      </span>{" "}
                      <span>💜 LEGENDARY VIBE</span>
                      <span className="text-[10px] uppercase w-16 text-right opacity-80">
                        ← YOU
                      </span>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 p-4 rounded-xl mt-4 text-center">
                  <p className="text-sm font-medium text-purple-100 drop-shadow-sm">
                    ...
                    <span className="font-bold">You're in top 5%</span> of all
                    SkrimChat creators!
                  </p>
                </div>
              </div>
