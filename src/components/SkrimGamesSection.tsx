  ...
  return (
    <div className="relative min-h-[80vh] w-full rounded-3xl overflow-hidden bg-[#080810] border border-white/10 mb-8 pt-4 pb-12">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-purple-600/10 blur-[100px] animate-pulse"
          style={{ animationDuration: "4s" }}
        />
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-cyan-600/10 blur-[100px] animate-pulse"
          style={{ animationDuration: "6s" }}
        />
        <div
          className="absolute top-[40%] right-[20%] w-[30%] h-[30%] rounded-full bg-pink-600/10 blur-[100px] animate-pulse"
          ...
          <div className="flex gap-4 overflow-x-auto no-scrollbar pb-4 -mx-4 px-4 md:mx-0 md:px-0">
            {RECENT_GAMES.map((recent, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="shrink-0 w-[160px] bg-white/5 border border-white/10 p-3 rounded-2xl hover:border-white/30 transition-colors group cursor-pointer"
                >
                  <h4 className="text-white font-bold text-sm tracking-tight mb-1 truncate">
                    {game.title}
                  </h4>
          ...
          <AnimatePresence mode="popLayout">
            {filteredGames.map((game, idx) => (
              ...
              >
                {/* Game Art Container */}
                <div
                  className={`w-full h-[120px] md:h-[140px] bg-gradient-to-br ${game.color} to-black/80 relative overflow-hidden flex items-center justify-center p-4`}
                >
                  {game.hot && (
                ...
                <div className="p-3.5 flex-1 flex flex-col">
                  <h3 className="text-white font-bold text-sm tracking-tight mb-1.5">
                    {game.title}
                  </h3>
