...
const THEMES = [
  {
    id: "neon",
    name: "🔮 Neon",
    gradient: "from-[#B026FF] to-[#00F0FF]",
    qr: "#B026FF",
    qrBg: "transparent",
    glow: "shadow-[0_0_20px_rgba(176,38,255,0.4)]",
  },
  {
    id: "ocean",
    name: "🌊 Ocean",
  ...
  },
  {
    ...
    qr: "#8A2BE2",
    qrBg: "transparent",
    glow: "shadow-[0_0_20px_rgba(138,43,226,0.4)]",
  },
  {
    id: "nova",
    name: "⭐ Nova",
...
const MORE_PLATFORMS = [
  {
    ...
    icon: MessageCircle,
    label: "Arattai",
    textClass: "text-[#FF9933] group-hover:text-white",
    bgClass:
      "bg-[#FF9933]/10 group-hover:bg-[#FF9933]/20 border-2 border-neon-purple shadow-[0_0_15px_rgba(176,38,255,0.4)]",
    isFeatured: true,
  },
  {
    id: "whatsapp",
    ...
    bgClass: "bg-white/5 border border-white/10 group-hover:bg-[#25D366]/20",
  },
  {
    id: "twitter",
    icon: Twitter,
    label: "Twitter/X",
    textClass: "group-hover:text-[#1DA1F2]",
    bgClass: "bg-white/5 border border-white/10 group-hover:bg-[#1DA1F2]/20",
  },
  {
    id: "facebook",
    icon: Facebook,
    label: "Facebook",
    textClass: "group-hover:text-[#1877F2]",
    bgClass: "bg-white/5 border border-white/10 group-hover:bg-[#1877F2]/20",
  },
  {
    id: "linkedin",
    icon: Linkedin,
    ...
    bgClass: "bg-white/5 border border-white/10 group-hover:bg-[#0A66C2]/20",
  },
  {
    id: "telegram",
    icon: Send,
    label: "Telegram",
    textClass: "group-hover:text-[#0088cc]",
    bgClass: "bg-white/5 border border-white/10 group-hover:bg-[#0088cc]/20",
  },
  {
    id: "email",
    icon: Mail,
    ...
    bgClass: "bg-white/5 border border-white/10 group-hover:bg-[#EA4335]/20",
  },
  {
    id: "copy",
    icon: Copy,
    ...
    bgClass: "bg-white/5 border border-white/10 group-hover:bg-white/20",
  },
];
...
export function ShareProfileSheet({
  ...
  const handlePlatformShare = (platform: any) => {
    ...
    if (platform.id === "copy") {
      ...
      window.open(
        `https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(fullUrl)}&hashtags=SkrimChat`,
        "_blank",
      );
      ...
      window.open(
        `mailto:?subject=${encodeURIComponent("Check out my SkrimChat profile!")}&body=${encodeURIComponent(shareText + "\n\n" + fullUrl)}`,
        "_blank",
      );
          ...
          <div className="flex flex-col items-center pt-4 pb-4 relative shrink-0 z-20 bg-[#141414]/90">
            ...
            {view === "more" && (
              <button
                ...
                className="absolute left-4 top-4 p-2 rounded-full bg-white/5 hover:bg-white/10 transition"
              >
            ...
            <h3 className="text-white font-bold text-lg flex items-center gap-2">
              {view === "main" ? "Share Your Identity" : "More Options"}{" "}
              <Zap className="w-4 h-4 text-neon-purple fill-neon-purple" />
            </h3>
          </div>
              ...
              {view === "main" && (
                ...
                >
                    ...
                    >
                      ...
                      <div className="relative z-10 flex flex-col items-center text-center">
                        <AvatarWithRing
                          src={user.avatar}
                          size="xl"
                          className="mb-4 ring-2 ring-white shadow-xl"
                        />
                        <div className="bg-black/20 backdrop-blur-md px-3 py-1 rounded-full flex items-center gap-1.5 mb-2 border border-white/10">
                          ...
                          <span className="text-[#FFD700] text-[10px] font-black tracking-wider">
                            CREATOR
                          </span>
                        </div>
                        ...
                        <p className="text-white/80 font-medium text-sm mb-4 drop-shadow-sm">
                        ...
                        {user.bio && (
                          <p className="text-white/90 text-sm font-medium italic mb-6 leading-relaxed px-4 text-center line-clamp-3">
                            "{user.bio}"
                          </p>
                        )}
                  ...
                  <div className="flex flex-col items-center justify-center py-6 px-4 bg-white/5 border border-white/10 rounded-3xl relative overflow-hidden">
                    {/* Background Glow */}
                    <div
                      className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 blur-[60px] opacity-40 rounded-full transition-colors`}
                    ...
                    <div className="bg-transparent p-4 rounded-2xl relative z-10 flex flex-col items-center group">
                      <div
                        className={`p-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md transition-shadow relative ${activeTheme.glow}`}
                      >
                        <QRCodeSVG
                      ...
                      <p className="mt-6 text-sm font-bold text-white tracking-wide">
                        Scan to visit my SkrimChat
                      </p>
                  ...
                  <div className="flex flex-col gap-3 pt-2">
                    <button className="w-full flex items-center gap-4 bg-gradient-to-r from-neon-purple/20 to-neon-blue/20 hover:from-neon-purple/30 hover:to-neon-blue/30 border border-neon-purple/30 p-4 rounded-2xl transition-all group">
                      ...
                      <div className="flex flex-col items-start">
                        <span className="text-white font-bold">
                          Share as Pulse Story
                        </span>
                        <span className="text-xs text-gray-400">
                          Post your card to your Sparks
                        </span>
                      </div>
                    </button>
                    ...
                    <button className="w-full flex items-center gap-4 bg-white/5 border border-white/10 hover:bg-white/10 p-4 rounded-2xl transition-all group">
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-xs text-gray-400">
                          Send privately in encrypted chat
                        </span>
                      </div>
                    </button>
                  ...
                  <div className="flex flex-col bg-white/5 border border-white/10 rounded-3xl p-6 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-4 gap-y-8 gap-x-2 relative z-10">
                      {MORE_PLATFORMS.map((platform, i) => (
                        ...
                        >
                          <div
                            className={`w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110 ${platform.bgClass}`}
                          >
                            <platform.icon
                              className={`w-6 h-6 text-gray-300 transition-colors ${platform.textClass}`}
                            />
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            ...
                            {copied && platform.id === "copy" && (
                              <span className="text-[9px] bg-green-500/20 text-green-400 px-1.5 py-0.5 rounded-full absolute -bottom-5 whitespace-nowrap">
                                ✓ Copied!
                              </span>
                            )}
                          </div>
