            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <div className="mt-4 bg-white/5 border border-white/10 rounded-2xl p-5 text-gray-200 text-sm leading-relaxed italic relative">
                  <span className="absolute -top-3 -left-2 text-4xl text-[#B026FF] opacity-30">
                    "
                  </span>
                  {post?.hasStory && post.storyText
                    ? post.storyText
                    : "This is a moment that actually meant a lot to me. Just wanted to share the pure vibe with the Skrim fam."}
                  <span className="absolute -bottom-4 right-2 text-4xl text-[#B026FF] opacity-30">
                    "
                  </span>
                </div>
              </div>
