...
const MOCK_PHOTOS = [
  { id: "p1", emoji: "🌅", color: "#ff7e5f" },
  { id: "p2", emoji: "🎉", color: "#feb47b" },
  { id: "p3", emoji: "🏏", color: "#228B22" },
  { id: "p4", emoji: "🌸", color: "#FF69B4" },
  { id: "p5", emoji: "🌃", color: "#2b5876" },
  { id: "p6", emoji: "😂", color: "#FFD700" },
  { id: "p7", emoji: "🍛", color: "#D2691E" },
  { id: "p8", emoji: "🔥", color: "#FF4500" },
];

const MOCK_VIDEOS = [
  { id: "v1", emoji: "🏄", color: "#00C9FF", duration: "0:32" },
  { id: "v2", emoji: "🐕", color: "#f3a183", duration: "1:15" },
  { id: "v3", emoji: "🎢", color: "#8E2DE2", duration: "2:40" },
  { id: "v4", emoji: "🎸", color: "#4A00E0", duration: "0:18" },
];
        ...
        return (
          <div className="grid grid-cols-3 gap-y-6 gap-x-4 p-8">
            {ATTACH_OPTIONS.map((opt) => (
              ...
              >
                <div
                  className={`w-14 h-14 rounded-full bg-gradient-to-br ${opt.gradient} flex items-center justify-center shadow-lg`}
                >
        ...
        return (
          <div className="flex flex-col h-full bg-[#1A1A24]">
            ...
            <div className="p-4 flex gap-2">
              <button className="flex-1 py-2 bg-white/10 rounded-lg text-white font-medium text-sm flex items-center justify-center gap-2">
            ...
            <div className="px-4 pb-2 text-[10px] uppercase font-bold text-white/40 tracking-wider">
              Recent Photos
            </div>
      ...
      case "video":
        return (
          <div className="flex flex-col h-full bg-[#1A1A24]">
            ...
            <div className="px-4 py-2 text-[10px] uppercase font-bold text-white/40 tracking-wider">
              Recent Videos
            </div>
            <div className="flex-1 overflow-y-auto px-4 pb-4">
              <div className="grid grid-cols-2 gap-2">
                {MOCK_VIDEOS.map((v) => (
                  ...
                  >
                    ...
                    <span className="absolute bottom-1 right-2 text-[10px] text-white font-mono bg-black/60 px-1 rounded">
                      {v.duration}
                    </span>
                  </button>
                ))}
          ...
          <div className="flex flex-col h-full bg-[#1A1A24]">
            ...
            <div className="px-4 py-2">
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2 text-sm text-white focus:outline-none focus:border-neon-purple"
              />
            </div>
            <div className="px-4 py-2 text-[10px] uppercase font-bold text-white/40 tracking-wider">
              Trending Songs
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                      ...
                      <div className="flex gap-2 mt-2">
                        <button className="text-[10px] bg-white/10 px-2 py-1 rounded text-white">
                        ...
                        <button
                          ...
                          className="text-[10px] bg-neon-purple text-white px-3 py-1 rounded font-bold shadow-[0_0_8px_rgba(176,38,255,0.4)]"
                        >
                          Share
                        </button>
                      </div>
        ...
        return (
          <div className="flex flex-col h-full bg-[#1A1A24]">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 no-scrollbar">
              <div className="mb-6">
                <div className="text-[10px] uppercase font-bold text-white/40 tracking-wider mb-2">
                  Question
                </div>
                <input
                  type="text"
              ...
              <div className="mb-6">
                <div className="text-[10px] uppercase font-bold text-white/40 tracking-wider mb-3">
                  Settings
                </div>
