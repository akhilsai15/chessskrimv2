  ...
  return (
    <div className="fixed inset-0 z-[10000] bg-black">
      <div className="absolute top-0 inset-x-0 p-4 pt-12 flex justify-between items-center z-50">
        ...
        <button
          onClick={onClose}
          className="w-10 h-10 rounded-full bg-black/50 backdrop-blur-md border border-white/10 flex items-center justify-center text-white/70 hover:text-white"
        >
          <X size={20} />
        </button>
      </div>
        ...
        {scoreToBeat > 0 && (
          <div className="bg-[#10b981]/20 border border-[#10b981]/50 px-6 py-2 rounded-full flex items-center gap-2">
            ...
            <span className="text-white font-bold text-sm">
              Beat {opponentName}'s {scoreToBeat}!
            </span>
          </div>
        )}
      </div>
      ...
      {!isPlaying && !gameOver ? (
        ...
        <div className="h-full flex flex-col items-center justify-center p-6 relative">
          <div className="text-white/50 font-mono text-2xl absolute top-48">
        ...
        <div className="h-full flex flex-col items-center justify-center p-6 text-center">
          <div
            className={`text-6xl mb-6 ${score > scoreToBeat ? "text-yellow-400" : "text-red-400"}`}
          >
            {score > scoreToBeat ? "👑" : "😭"}
          </div>
          ...
          <p className="text-white/70 mb-8 font-medium">
            {score > scoreToBeat
              ...
              : `Not quite enough to beat ${scoreToBeat}.`}
          </p>
