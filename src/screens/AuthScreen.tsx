...
export default function AuthScreen() {
  ...
  const [otpSource, setOtpSource] = useState<"signup" | "phone-login">(
    "signup",
  );
        ...
        setTimeout(() => {
          if (otpSource === "phone-login") {
            ...
            const found = existingUsers.find(
              (u: any) => u.phone === phone || u.phone === fullPhone,
            );
            if (found) {
  ...
  return (
    <div
      ref={scrollRef}
      className="w-full h-full relative overflow-hidden bg-[#0A0A0A] flex flex-col lg:overflow-y-auto lg:overflow-x-hidden lg:items-center lg:justify-start"
    >
      ...
      <AnimatePresence>
        {slideIndex === 0 && step !== "splash" && (
          <motion.div
            ...
            className="absolute inset-0 lg:fixed lg:top-0 lg:left-0 lg:w-[100vw] lg:h-[100vh] lg:z-0 pointer-events-none"
          >
        ...
        {slideIndex === 2 && step !== "splash" && (
          ...
          >
            ...
            {[...Array(20)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute w-1 h-1 bg-white rounded-full opacity-50 shadow-[0_0_5px_white]"
                style={{
                  top: `${Math.random() * 100}%`,
      ...
      <AnimatePresence mode="wait">
          ...
          >
            <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-neon-purple to-neon-blue p-[2px]">
              <div className="w-full h-full bg-skrim-bg rounded-[22px] flex items-center justify-center">
                <span className="text-4xl font-bold bg-gradient-to-br from-neon-purple to-neon-blue text-transparent bg-clip-text">
                  S
                </span>
              </div>
            </div>
            <h1 className="text-3xl font-bold tracking-tight">
              Skrim
              <span className="text-neon-purple text-glow-purple">Chat</span>
            </h1>
        ...
        {step === "onboarding" && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -50 }}
            className="w-full max-w-[560px] mx-auto h-[100vh] flex flex-col items-center justify-between z-10 px-6 pb-[env(safe-area-inset-bottom,32px)] box-border relative lg:max-w-none lg:w-[100vw] lg:min-h-[100vh] lg:h-[100vh] lg:overflow-y-auto lg:overflow-x-hidden lg:flex-col lg:items-center lg:pt-0 lg:pb-0 scroll-smooth"
            onTouchStart={handleTouchStart}
            onTouchEnd={handleTouchEnd}
            onScroll={handleScroll}
          >
            {/* Inner Wrapper for max-w on Web */}
            <div className="w-full h-full flex flex-col items-center justify-between lg:w-full lg:max-w-[600px] lg:mx-auto lg:px-[24px] lg:pt-[60px] lg:pb-[60px] lg:flex-col lg:items-center lg:gap-[24px] lg:h-max lg:min-h-[100vh] lg:justify-center flex-1">
              {/* Skip Button */}
              {slideIndex < 2 && (
                ...
                >
                    ...
                    <div className="w-[180px] h-[180px] md:w-[220px] md:h-[220px] lg:w-[200px] lg:h-[200px] relative shrink-0">
                      ...
                      >
                        <img
                          ...
                          className="w-8 h-8 rounded-full border-2 border-[#00F0FF] absolute -top-4 left-[64px] md:left-[80px] lg:left-[90px]"
                          alt="user"
                        />
                        <img
                          src="https://i.pravatar.cc/150?img=5"
                          className="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 rounded-full border-2 border-[#00F0FF] absolute bottom-[16px] -left-2"
                          alt="user"
                        />
                        <img
                          src="https://i.pravatar.cc/150?img=6"
                          className="w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full border-2 border-[#00F0FF] absolute bottom-[8px] -right-3 lg:-right-4"
                          alt="user"
                        />
                      </motion.div>
                    </div>
                  ...
                  {slideIndex === 2 && (
                    <div className="w-[180px] h-[180px] md:w-[220px] md:h-[220px] lg:w-[200px] lg:h-[200px] relative shrink-0">
                      <motion.div
                        ...
                        className="absolute inset-[-10px] md:inset-[-15px] lg:inset-[-18px] border-[3px] border-dashed border-[#B026FF]/50 rounded-full p-2"
                      />
                      <motion.div
                        animate={{ rotate: 360 }}
                        transition={{
                        ...
                        className="absolute inset-[-18px] md:inset-[-25px] lg:inset-[-30px] border-[2px] border-transparent border-t-[#FF2D87] border-b-[#FF2D87] rounded-full opacity-70"
                      />
                      ...
                      <motion.div
                        animate={{ scale: [1, 1.05, 1] }}
                        transition={{ duration: 2, repeat: Infinity }}
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-[#B026FF] to-[#FF2D87] w-[70px] h-[70px] md:w-[90px] md:h-[90px] lg:w-[100px] lg:h-[100px] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(255,45,135,0.6)] z-20"
                      >
                      ...
                      <motion.div
                        ...
                        className="absolute -top-3 -right-6 md:-top-4 md:-right-8 bg-white/10 backdrop-blur-md border border-white/20 px-2 py-1 md:px-3 md:py-1.5 lg:px-4 lg:py-2 rounded-xl z-30"
                      >
                        <span className="text-[9px] md:text-[10px] lg:text-[11px] font-bold text-white">
                          1.2M Views
                        </span>
                      </motion.div>
                      <motion.div
                        ...
                        className="absolute top-1/2 -left-10 md:-left-12 transform -translate-y-1/2 bg-white/10 backdrop-blur-md border border-white/20 px-2 py-1 md:px-3 md:py-1.5 lg:px-4 lg:py-2 rounded-xl z-30"
                      >
                        <span className="text-[9px] md:text-[10px] lg:text-[11px] font-bold text-white">
                          128K Followers
                        </span>
                      ...
                      <motion.div
                        ...
                        className="absolute -bottom-5 -right-3 md:-bottom-6 md:-right-4 lg:-bottom-8 lg:-right-6 bg-[#FF2D87]/20 backdrop-blur-md border border-[#FF2D87]/30 px-2 py-1 md:px-3 md:py-1.5 lg:px-4 lg:py-2 rounded-xl z-30"
                      >
                        <span className="text-[9px] md:text-[10px] lg:text-[11px] font-bold text-white">
                          $4.2K Earned
                        </span>
                  ...
                  {slideIndex === 0 && (
                    <div className="flex flex-col items-center">
                      <h2 className="text-[28px] md:text-3xl lg:text-[32px] font-bold text-center leading-tight">
                        Feel the{" "}
                      ...
                      <p className="text-sm md:text-base lg:text-[15px] text-gray-400 text-center max-w-sm">
                        Experience the ultimate all-in-one social platform.
                        Connect, Create, and Converse safely.
                      </p>
                    </div>
                  )}
                  {slideIndex === 1 && (
                    <div className="flex flex-col items-center">
                      <h2 className="text-[28px] md:text-3xl lg:text-[32px] font-bold text-center leading-tight">
                        Connect{" "}
                        <span className="text-[#00F0FF] drop-shadow-[0_0_15px_rgba(0,240,255,0.8)]">
                          Beyond
                        </span>
                        <br />
                        Boundaries.
                      ...
                      <div className="h-[12px] md:h-[16px] shrink-0" />
                      <p className="text-sm md:text-base lg:text-[15px] text-gray-400 text-center max-w-sm">
                        Chat privately with end-to-end encryption. Call,
                        collaborate, and create with people who matter most.
                      </p>
                    </div>
                  )}
                  {slideIndex === 2 && (
                    <div className="flex flex-col items-center">
                      <h2 className="text-[28px] md:text-3xl lg:text-[32px] font-bold text-center leading-tight">
                        Create. Share.
                        <br />
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#B026FF] to-[#FF2D87] drop-shadow-[0_0_10px_rgba(255,45,135,0.4)]">
                          Get Rewarded.
                        </span>
                      </h2>
                      <div className="h-[12px] md:h-[16px] shrink-0" />
                      <p className="text-sm md:text-base lg:text-[15px] text-gray-400 text-center max-w-sm">
                        Share your Vibes, grow your audience, and monetize your
                        content. Your creativity. Your earnings.
                      </p>
                    </div>
                  )}
                </motion.div>
              ...
              <div className="w-full max-w-[560px] shrink-0">
                ...
                {slideIndex === 2 && (
                  <button
                    onClick={() => setStep("login")}
                    className="w-full h-[52px] bg-gradient-to-r from-[#B026FF] to-[#FF2D87] text-white font-bold rounded-2xl shadow-[0_0_25px_rgba(255,45,135,0.6)] flex items-center justify-center gap-2 transition-transform active:scale-95 text-sm uppercase tracking-wider"
                  >
                    Start Creating →
                  </button>
                )}
              ...
              <div className="flex gap-2 shrink-0 z-20">
                <div
                  ...
                  className={`h-2 rounded-full cursor-pointer transition-all duration-300 ${slideIndex === 0 ? "w-8 bg-neon-purple shadow-neon-purple" : "w-2 bg-gray-700"}`}
                />
                <div
                  onClick={() => setSlideIndex(1)}
                  className={`h-2 rounded-full cursor-pointer transition-all duration-300 ${slideIndex === 1 ? "w-8 bg-[#00F0FF] shadow-[0_0_10px_#00F0FF]" : "w-2 bg-gray-700"}`}
                />
                <div
                  onClick={() => setSlideIndex(2)}
                  className={`h-2 rounded-full cursor-pointer transition-all duration-300 ${slideIndex === 2 ? "w-8 bg-gradient-to-r from-[#B026FF] to-[#FF2D87] shadow-[0_0_10px_#FF2D87]" : "w-2 bg-gray-700"}`}
                />
              </div>
            </div>
          ...
          >
            <div className="flex-1 overflow-y-auto no-scrollbar pt-16 lg:flex-none lg:overflow-visible lg:pt-0">
              ...
              <p className="text-gray-400 mb-8">
                Login to continue to SkrimChat.
              </p>
              ...
              {error && (
                <div className="bg-[rgba(255,39,39,0.1)] border border-[rgba(255,39,39,0.3)] rounded-[12px] py-[12px] px-[16px] mb-6 flex items-start gap-2">
                  ...
                  <span className="text-[14px] text-[#FF6B6B] leading-tight">
                    {error}
                  </span>
                </div>
              )}
              {forgotEmailSent && (
                <div className="bg-[rgba(0,240,255,0.1)] border border-[rgba(0,240,255,0.3)] rounded-[12px] py-[12px] px-[16px] mb-6 flex items-start gap-2">
                  ...
                  <span className="text-[14px] text-[#00F0FF] leading-tight">
              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-skrim-surface border border-gray-800 rounded-xl px-4 py-3 mt-1 focus:outline-none focus:border-neon-purple focus:ring-1 focus:ring-neon-purple/50 transition-all text-white"
                  />
                </div>
                <div>
                  <label className="text-xs font-medium text-gray-400 ml-2">
                ...
                <div className="flex justify-end">
                  <span
                    ...
                    className="text-sm font-medium text-neon-blue cursor-pointer hover:underline"
                  >
                    Forgot Password?
                  </span>
                </div>
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      placeholder="bappu_bhai"
                      className="w-full bg-skrim-surface border border-gray-800 rounded-xl pl-9 pr-4 py-3 focus:outline-none focus:border-neon-purple focus:ring-1 focus:ring-neon-purple/50 transition-all text-white"
                    />
                  </div>
                </div>
                <div>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      className={`w-full bg-skrim-surface border rounded-xl px-4 py-3 mt-1 focus:outline-none transition-all text-white pr-10 hover:border-white/20 ${
                        confirmPassword
        ...
        {step === "otp" && (
          ...
          >
            <div
              className="flex items-center mb-10 mt-4 cursor-pointer"
              onClick={() =>
                setStep(otpSource === "phone-login" ? "phone-login" : "signup")
              }
            >
              ...
              <div className="space-y-8">
                <form onSubmit={handleVerifyOTP} className="space-y-8">
                    ...
                    {[0, 1, 2, 3, 4, 5].map((index) => (
                      <input
                        ...
                        className={`w-[45px] h-[55px] sm:w-[50px] sm:h-[60px] bg-skrim-surface border ${
                          otpValues[index]
                            ? "border-neon-purple/50 bg-[#B026FF] bg-opacity-20 text-white"
                  ...
                  <button
                    type="submit"
                    disabled={
                      loading || otpSuccess || otpValues.join("").length < 6
                    }
                  ...
                  >
                    {otpSuccess ? (
                      ...
                      >
                        <div className="w-5 h-5 rounded-full bg-white text-[#B026FF] flex items-center justify-center text-xs font-black">
                          ✓
                        </div>
                        Verified!
                      </motion.div>
              ...
              <div className="flex flex-col items-center mb-8 relative">
                ...
                >
                  {avatarBase64 ? (
                    ...
                    <span className="text-[#B026FF] text-sm font-medium">
                      + Add photo
                    </span>
                  )}
                  {avatarBase64 && (
              ...
              <form onSubmit={handleProfileSetupSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    />
                    <span
                      className={`absolute bottom-3 right-3 text-xs font-medium ${bio.length >= 145 ? "text-red-500" : bio.length >= 120 ? "text-orange-500" : "text-gray-500"}`}
                    >
                      {bio.length}/150
                    </span>
                  </div>
